...
client = InfluxDBClient('localhost', 8086, database='machine_data')
...
class GetMachineData(threading.Thread):
    def __init__(self, name):
        ...
        client.create_continuous_query(self.name + '_30m', select, 'machine_data')
